...
export default function ChildDashboard({ user }: ChildDashboardProps) {
  ...
  return (
    <div className="bg-primary-950 relative flex min-h-screen w-full">
      <ChildSidebar />

      <section className="bg-primary-800 outline-primary-400/40 ml-20 flex w-full flex-col-reverse gap-4 rounded-tl-3xl rounded-bl-3xl p-4 outline sm:gap-6 sm:p-6 lg:flex-row lg:gap-0 lg:p-0">
        <div className="col-span-2 flex flex-1/2 auto-rows-min flex-col gap-4 sm:grid sm:grid-cols-2 sm:gap-6 lg:max-w-2xl lg:p-6">
          <Link href="/aprendiz/missoes" className="h-fit sm:col-span-2">
            <div className="bg-primary-600 group border-primary-500/40 overflow-hidden rounded-xl border">
              <AspectRatio
                ratio={isMobile ? 16 / 9 : 8 / 3}
        ...
        <div className="bg-primary-900 outline-primary-700 relative flex min-w-fit flex-col gap-12 rounded-3xl rounded-bl-3xl p-4 outline sm:p-6 lg:flex-1 lg:rounded-tr-none lg:rounded-br-none">
          <div className="flex items-center justify-between gap-4">
            ...
            <Button
              variant="pixel"
              size="pixel"
              className="z-10 px-3 max-sm:absolute max-sm:top-10 max-sm:right-4"
          ...
          <div className="mx-auto flex max-w-68 flex-col items-start gap-6">
